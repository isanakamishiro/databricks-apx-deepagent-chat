...
from ._volume_path import VolumePathDependency
...
class Dependencies:
    ...
    VolumePath: TypeAlias = VolumePathDependency
    """Volume path from x-uc-volume-path header.
    Recommended usage: `volume_path: Dependencies.VolumePath`"""
